...
export const ProfilePhoto = (props: {
	targetUser?: Tables<"users">;
	setFile?: Dispatch<SetStateAction<File | null>>;
	setPpHasChanged?: Dispatch<SetStateAction<boolean>>;
	name: string;
}) => {
	...
	const handleFileInputChange = async (e: ChangeEvent<HTMLInputElement>) => {
		...
		const basePathStorage = supabase.storage.from("avatars").getPublicUrl("")
			.data.publicUrl;
