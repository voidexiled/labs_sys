...
export const LaboratoriesFilters = () => {
    ...
    */
    ...
    return (
        <>
            <div className="flex flex-row w-full mb-4 rounded-md gap-1 py-1 justify-between flex-wrap p-3 lg:pl-0 lg:pr-8">
                ...
                <div className="flex items-center gap-2 justify-center lg:justify-normal flex-wrap flex-grow lg:flex-grow-0">
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuCheckboxItem onSelect={() => handleFilter("busy")} checked={status === "busy"}>
                                Ocupado
                            </DropdownMenuCheckboxItem>
                            <DropdownMenuCheckboxItem onSelect={() => handleFilter("idle")} checked={status === "idle"}>
                                Disponible
                            </DropdownMenuCheckboxItem>
                            <DropdownMenuCheckboxItem onSelect={() => handleFilter("oos")} checked={status === "oos"}>
                                Fuera de servicio
                            </DropdownMenuCheckboxItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
