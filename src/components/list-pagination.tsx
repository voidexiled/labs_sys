                    ...
                    <>
                        ...
                        >
                            <PaginationLink href={{
                                ...
                                className={cn(currentPage === pages.at(0) && "bg-primary text-primary-foreground hover:bg-primary/80 hover:text-primary-foreground/80")}>
                                {pages.at(0)?.toString()}
                            </PaginationLink>
                        </PaginationItem>
                    ...
                    <>
                        ...
                        >
                            <PaginationLink href={{
                                ...
                                className={cn(currentPage === pages.length && "bg-primary text-primary-foreground hover:bg-primary/80 hover:text-primary-foreground/80")}>
